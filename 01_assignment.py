...
def exercise03():
    ...
    # ------ Place code below here \/ \/ \/ ------
    sentence = 'arbitarary wordy sentence'
    # ------ Place code above here /\ /\ /\ ------
...
def exercise12():
    ...
    # Then create a variable y that equals to x to the 7th power
...
def exercise13():
    # Create variables volume_sphere, r. 
    # Set r to 7 and calculate the volume of the sphere with r = 7 and assign it to volume_sphere

    pi = 3.14159
    # ------ Place code below here \/ \/ \/ ------ 
    r = 7
    volume_sphere = (1.33333333) * pi * (r ** 3)
    # ------ Place code above here /\ /\ /\ ------
...
def exercise16():
    ...
    # Select any numbers for a and b. Use math.sqrt() for square root.
